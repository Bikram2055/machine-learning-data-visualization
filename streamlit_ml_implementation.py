...
st.button('hello')
st.header('i am the boss')
st.info('this is the site i made')
st.write('sun sine in the east')
st.download_button(data='automate.spec', label='file')
st.dataframe(data)
st.text_input('enter your name')
# st.info(input1)
st.info('this is table')
st.table(data)
